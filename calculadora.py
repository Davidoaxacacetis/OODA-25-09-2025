...
def home():
    ...
    mensaje += "<ol>"
    mensaje += "<li><h2> Sumar http://127.0.0.1:5000/suma/10/20</h2></li>"
    mensaje += "<li><h2> Restar http://127.0.0.1:5000/restar/10/20</h2></li>"
    mensaje += "<li><h2> Multiplicación http://127.0.0.1:5000/multiplicacion/10/20</h2></li>"
    mensaje += "<li><h2> División http://127.0.0.1:5000/division/10/20</h2></li>"
